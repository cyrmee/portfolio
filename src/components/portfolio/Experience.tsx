  ...
  const experiences = [
    {
      ...
      technologies: ["C#", "Python", "GraphQL", "Azure AI", "MongoDB", "Azure Functions"]
    },
    {
    ...
    },
    {
      ...
      technologies: ["NestJS", "TypeScript", "PostgreSQL", "Prisma", "Socket.io", "OAuth 2.0"]
    },
    {
      title: "Backend Developer",
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Building scalable backend solutions across different industries and technologies
            </p>
          </div>
