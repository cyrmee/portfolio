  ...
  const certifications = [
    {
      ...
      credlyUrl:
        "https://www.credly.com/badges/c6dc42aa-f8fa-485d-b7f7-afbaf3789f67",
      featured: true,
    },
    {
      ...
      credlyUrl:
        "https://www.credly.com/badges/2af18bc8-1592-44d7-9e0f-6bfbe7b911a6",
      featured: true,
    },
    {
            ...
            <div>
              ...
              <div className="grid gap-6">
                {certifications.map((cert, index) => (
                  <Card
                    key={index}
                    className="border-0 shadow-medium hover:shadow-large transition-shadow w-full"
                  >
